---
name: forest-tales-network
description: Implement ForestTales transport, serialization, connectivity, retries, timeouts, and diagnostics after Phase 7 approval.
---
